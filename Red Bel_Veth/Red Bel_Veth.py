...
class PowerUp(pygame.sprite.Sprite):
    ...
    def activate_power_up(self, player):
        ...
        player.shoot_delay -= 40  # Reducir el retardo entre disparos

        # Establecer un límite mínimo para la velocidad de disparo
        if player.shoot_delay < 10:
...
class HUD:
    ...
    def draw(self, screen):
        score_text = self.font.render(f"PUNTUACIÓN: {self.player.score}", True, (255, 255, 255))
...
class Game:
    ...
    def update(self):
        ...
        # Actualizar las explosiones y eliminar las que hayan terminado
